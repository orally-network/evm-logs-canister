...
///
/// Cycles per byte sent.
pub const CYCLES_PER_BYTE_SEND: u64 = 1000;
/// Cycles per byte received
pub const CYCLES_PER_BYTE_RECEIVE: u64 = 1000;

/// Size estimation for Ethereum log event and related data.
///
/// Measured in bytes for one received EVM event.
pub const EVM_EVENT_SIZE_BYTES: u32 = 800;
/// Size of one Ethereum address
pub const ETH_ADDRESS_SIZE: u32 = 20;
/// Size of one Ethereum topic
pub const ETH_TOPIC_SIZE: u32 = 32;
